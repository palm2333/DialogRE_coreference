...
if __name__ == "__main__":
    ...
    early_stopping = callbacks.EarlyStopping(patience=5,strict=True,verbose=True,**checkpoint_args)
    ...
    # ckpt_callback = callbacks.ModelCheckpoint(
    #     dirpath=os.path.join(logger.log_dir, '{epoch}-{val_loss:.4f}-{eval_f1:.4f}-{eval_T2:.3f}'),
