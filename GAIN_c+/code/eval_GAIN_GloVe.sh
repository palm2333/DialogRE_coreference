...
nohup python3 -u test.py \
  --train_set ../c+_conv/train.json \
  --train_set_save ../c+_conv/prepro_data/train_GloVe.pkl \
  --dev_set ../c+_conv/dev.json \
  --dev_set_save ../c+_conv/prepro_data/dev_GloVe.pkl \
  --test_set ../c+_conv/${dataset}.json \
  --test_set_save ../c+_conv/prepro_data/${dataset}_GloVe.pkl \
  --use_model bilstm \
